...
graph LR
    %% Первый ряд
    A["Загрузка документа"] --> B["Сегментация текста"] --> C["Предварительная оценка"]

    %% Второй ряд
    A --> D["Определение языка и структуры"]
    B --> E["Обработка сегментов и метаданных"]
    C --> F["Индексация сегментов и метаданных"]
